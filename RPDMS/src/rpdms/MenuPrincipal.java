...
public final class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botão_viatura.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                botão_viaturaMouseClicked(evt);
            }
        });
        ...
        botão_casos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                botão_casosMouseClicked(evt);
            }
        });
        ...
        botão_relatorios.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                botão_relatoriosMouseClicked(evt);
            }
        });
        botão_relatorios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botão_relatoriosActionPerformed(evt);
            }
        });
        ...
        botão_cctv.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                botão_cctvMouseClicked(evt);
            }
        });
        botão_cctv.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botão_cctvActionPerformed(evt);
            }
        });
    ...
    private void SobreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SobreActionPerformed
        ...
        final Janela_Sobre sobre1 = Janela_Sobre.getInstance();
    ...
    private void SobreMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SobreMouseClicked
        ...
        if(evt.getSource()==Sobre){
            ...
            menuIni.setVisible(false);
            botão_umbrella.setEnabled(false);
        }
    ...
    private void botão_casosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botão_casosActionPerformed
        ...
        if(user.equals("Brian Irons") && pass.equals("2236")){
           ...
           Janela_Casos_pendentes.Adicionar.setVisible(true);
           Janela_Casos_pendentes.Editar.setVisible(true);
           Janela_Casos_pendentes.Arquivar.setVisible(true);
           Janela_Casos_pendentes.Encerrar.setVisible(true);
        }else{
           Janela_Casos_pendentes.Adicionar.setVisible(false);
           Janela_Casos_pendentes.Editar.setVisible(false);
           Janela_Casos_pendentes.Arquivar.setVisible(false);
           Janela_Casos_pendentes.Encerrar.setVisible(false);
        }
    ...
    private void botão_viaturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botão_viaturaActionPerformed
        Janela_Viatura viatura = Janela_Viatura.getInstance();
        ...
        if(user.equals("Brian Irons") && pass.equals("2236")){
           ...
           Janela_Viatura.adicionar.setVisible(true);
           Janela_Viatura.editar.setVisible(true);
           Janela_Viatura.remover.setVisible(true);
        }else{
           Janela_Viatura.adicionar.setVisible(false);
           Janela_Viatura.editar.setVisible(false);
           Janela_Viatura.remover.setVisible(false);
        }
    ...
    private void botão_viaturaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botão_viaturaMouseClicked
        try {
            AudioInputStream as = AudioSystem.getAudioInputStream(this.getClass().getResource("/Sounds/interfaceSFX/Botão_select.wav"));
            Clip clip = AudioSystem.getClip();
            clip.open(as);
    ...
    }//GEN-LAST:event_botão_viaturaMouseClicked
    ...
    private void botão_casosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botão_casosMouseClicked
        try {
            AudioInputStream as = AudioSystem.getAudioInputStream(this.getClass().getResource("/Sounds/interfaceSFX/Botão_select.wav"));
            Clip clip = AudioSystem.getClip();
            clip.open(as);
    ...
    }//GEN-LAST:event_botão_casosMouseClicked

    private void botão_cctvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botão_cctvActionPerformed
        final Janela_CCTV cctv = Janela_CCTV.getInstance();
        
        
        if(cctv.isVisible()){

        }else{
            jDesktopPane1.add(cctv);
        ...
        centralizarJanela(cctv);
        
        cctv.Botão_X.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent ae) {
                botão_umbrella.setEnabled(true);
                ...
                cctv.dispose();
                cctv.getDesktopPane().remove(cctv);
            }
        });
    }//GEN-LAST:event_botão_cctvActionPerformed

    private void botão_cctvMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botão_cctvMouseClicked
        try {
            AudioInputStream as = AudioSystem.getAudioInputStream(this.getClass().getResource("/Sounds/interfaceSFX/Botão_select.wav"));
            Clip clip = AudioSystem.getClip();
            clip.open(as);
    ...
    }//GEN-LAST:event_botão_cctvMouseClicked

    private void botão_relatoriosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botão_relatoriosActionPerformed
        final Janela_Relatorios relatorio = Janela_Relatorios.getInstance();
        ...
        relatorio.Botão_X.addActionListener(new ActionListener() {
    ...
    }//GEN-LAST:event_botão_relatoriosActionPerformed

    private void botão_relatoriosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botão_relatoriosMouseClicked
        try {
            AudioInputStream as = AudioSystem.getAudioInputStream(this.getClass().getResource("/Sounds/interfaceSFX/Botão_select.wav"));
            Clip clip = AudioSystem.getClip();
            clip.open(as);
    ...
    }//GEN-LAST:event_botão_relatoriosMouseClicked
